...
% Question 1 et 2 réalisées avec l'image droite; voir dans la fonction
% differenceDeGaussiennes pour l'implémentation.
...
%% Question 3: Graphes des points coservés à chaque octave.
figure;
plot(conserved(:, 1), conserved(:, 2))
title('Points conservés par octave')
xlabel('Octave')
ylabel('Nb. de points')
